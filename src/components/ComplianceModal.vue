...
.compliance-loading, .compliance-error, .compliance-empty {
  ...
  min-height: 200px; gap: 12px; color: var(--c-text-3);
}
.spinner {
  width: 36px; height: 36px; border: 3px solid var(--c-surface-3);
...
.score-bg { fill: none; stroke: var(--c-surface-3); stroke-width: 3; }
.score-bar { fill: none; stroke: var(--c-success); stroke-width: 3; stroke-linecap: round; }
.score-mid .score-bar { stroke: var(--c-warn); }
.score-low .score-bar { stroke: var(--c-danger); }
.score-text {
  position: absolute; inset: 0; display: flex; align-items: center; justify-content: center;
  font-size: 22px; font-weight: 700; color: var(--c-text-0);
}
.summary-text { font-size: 14px; line-height: 1.6; color: var(--c-text-1); }
...
.label { color: var(--c-text-3); white-space: nowrap; min-width: 72px; }
...
.issue-tag.info { background: var(--c-info-bg); color: var(--c-info); }

.risk-low { color: var(--c-success); }
.risk-medium { color: var(--c-warn); }
