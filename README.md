...
[![Version](https://img.shields.io/badge/version-0.5.2-brightgreen)](https://github.com/zuowen7/scholar-assistant-agent/releases)
...
v0.5.2 — Latest: Vision settings UI + local OCR fallback (Tesseract / PaddleOCR) for text-only models, fixed update checker (backend-proxied GitHub Releases check), frozen-build vision config fix, privacy cleanup. MIT license.
